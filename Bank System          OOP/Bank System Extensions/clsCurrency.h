...
public:
    ...
    static bool IsCurrencyExistByCountry(string CountryCode)
    {
        clsCurrency C1 = clsCurrency::FindByCountry(CountryCode);
        return (!C1.IsEmpty());
    ...
    double ConvertToatherCurrency(double Amount, clsCurrency Currency2)
    {
